...
export default function RepairWizard({ initialDevice }: { initialDevice: string }) {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      const response = await fetch("/api/repairs", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, phone, email, deviceType: devices[deviceType].th, deviceModel: model, symptoms: selectedSymptoms, note, priority }) });
